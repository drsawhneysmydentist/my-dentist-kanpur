...
const TITLE = "Dental Health Blog | Dr Sawhney’s My Dentist Kakadeo Kanpur";
const DESC =
  "Expert dental health tips, treatment guides, and oral hygiene advice from Dr. Asheesh K. Sawhny and Dr. Karuna Singh Sawhny at DR SAWHNEY’S MY DENTIST, Kakadeo, Kanpur.";

const blogListSchema = {
  "@context": "https://schema.org",
  "@type": "Blog",
  name: "DR SAWHNEY’S MY DENTIST Kanpur — Dental Health Blog",
  url: `${SITE.url}/blog`,
  publisher: {
    "@type": "Dentist",
  ...
  return (
    <>
      <PageHeader
        ...
        intro="Expert advice on oral health, treatments, and keeping your smile healthy — from the specialists at DR SAWHNEY’S MY DENTIST, Kakadeo, Kanpur."
      />
