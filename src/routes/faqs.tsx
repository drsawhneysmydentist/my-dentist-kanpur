...
const ALL_FAQS = [
  ...SITE.faqs,
  {
    q: "Where is DR SAWHNEY’S MY DENTIST located in Kanpur?",
    a: "DR SAWHNEY’S MY DENTIST is located at 117/L-1/455A, P Block, Naveen Nagar, Kakadeo, Kanpur, Uttar Pradesh — near Panacea Hospital and Dwivedi Hospital. We are easily accessible from Pandu Nagar, Sharda Nagar, Swaroop Nagar, Civil Lines, Sarvodaya Nagar, Lajpat Nagar, Kaushalpuri, and RS Puram.",
  },
  {
    q: "Do you offer dental implants for missing teeth in Kanpur?",
    a: "Yes. DR SAWHNEY’S MY DENTIST offers world-class dental implants in Kanpur placed by Dr. Asheesh K. Sawhny — an American-certified implantologist (AAID). Treatments include single tooth implants, multiple implants, implant-supported bridges, and full-arch restoration. Book a consultation for your personalised dental implant cost in Kanpur.",
  },
  {
    q: "Are children welcome at DR SAWHNEY’S MY DENTIST?",
  ...
  },
  {
    ...
    a: "Most cosmetic smile makeovers at DR SAWHNEY’S MY DENTIST are completed in 2 to 4 visits over 2 to 3 weeks, depending on whether veneers, teeth whitening, contouring or orthodontics are involved. A digital preview is provided before any treatment begins.",
  },
  {
    q: "Do you accept insurance and offer EMI?",
    a: "DR SAWHNEY’S MY DENTIST supports leading insurance reimbursements and offers flexible EMI options for larger treatments such as implants, orthodontics and full-mouth rehabilitation. Please ask the front desk for current options.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. DR SAWHNEY’S MY DENTIST is open on Sundays from 11 AM to 2 PM. Monday through Saturday we are open in the evening from 4 PM to 9 PM — ideal for working patients who need a dentist open in the evening in Kanpur.",
  },
  {
    q: "Where can I get painless root canal treatment in Kanpur?",
    a: "DR SAWHNEY’S MY DENTIST, Kakadeo, Kanpur offers painless root canal treatment performed by Dr. Asheesh K. Sawhny, an MDS Endodontist with 21+ years of specialist experience. Single-sitting RCT is available for straightforward cases. Call +91 98385 00100 to book.",
  },
  {
    q: "What is the cost of teeth whitening in Kanpur?",
    a: "Teeth whitening costs at DR SAWHNEY’S MY DENTIST vary by the whitening method. Clinically supervised, customised whitening delivers safe and lasting results. Book a consultation for accurate, personalised pricing.",
  },
  {
    q: "Can I book a same-day or walk-in dentist appointment in Kanpur?",
    a: "Yes. DR SAWHNEY’S MY DENTIST offers same-day emergency appointments and walk-in dental care in Kanpur for urgent cases including severe tooth pain, swelling and broken teeth. For non-emergency treatment, we recommend booking in advance. Call +91 98385 00100 or WhatsApp us.",
  },
  {
    q: "What is root canal treatment?",
    a: "Root canal treatment (RCT) removes infected or inflamed pulp from inside a tooth, then cleans, shapes and seals the canal to relieve pain and save the natural tooth. At DR SAWHNEY’S MY DENTIST, Dr. Asheesh K. Sawhny — an MDS Endodontist — performs painless, single-sitting RCT using rotary instruments and apex-locator precision wherever clinically suitable.",
  },
  {
  ...
  },
  {
    ...
    a: "Rinsing with warm salt water, taking an over-the-counter pain reliever as directed, and avoiding very hot, cold or sugary food can ease tooth pain temporarily. This is not a substitute for treatment — for ongoing or severe pain, call DR SAWHNEY’S MY DENTIST at +91 98385 00100 for a same-day emergency appointment in Kanpur.",
  },
];
...
const TITLE = "Dental FAQs — Dr Sawhney’s My Dentist Kakadeo Kanpur | Root Canal Cost, Implant Cost, Braces Cost";
const DESC =
  "Answers to common dental questions: root canal treatment cost in Kanpur, dental implant cost in Kanpur, braces cost in Kanpur, Sunday dentist Kanpur, evening dentist, emergency dental care — from MDS specialists at Dr Sawhney’s My Dentist, Kakadeo, Kanpur.";
  ...
  return (
    <>
      <PageHeader
        ...
        intro="Direct, specialist-written answers to the most common questions we receive at DR SAWHNEY’S MY DENTIST Kanpur."
      />
            ...
            <div className="mt-16 flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-foreground/8 bg-card p-8 shadow-soft">
              <div>
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Speak with a specialist at DR SAWHNEY’S MY DENTIST — we'll guide you honestly.
                </p>
              </div>
              <Link
                to="/contact"
