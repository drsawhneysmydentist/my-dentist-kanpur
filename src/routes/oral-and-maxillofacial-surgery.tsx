...
const FAQS = [
  ...
  { q: "What types of oral surgery does DR SAWHNEY’S MY DENTIST perform?", a: "DR SAWHNEY’S MY DENTIST provides a full range of oral and maxillofacial surgical procedures: wisdom tooth extractions, surgical removal of impacted teeth, cyst and tumour removal, jaw fracture repair, pre-prosthetic surgery, bone grafting, sinus lift procedures and dental implant placement. We also perform soft-tissue procedures such as frenectomy, gingivectomy, operculectomy and mucocele excision, with laser-assisted techniques available for select cases. All surgeries are performed in our fully equipped, sterile surgical suite in Kakadeo, Kanpur." },
...
const BENEFITS = [
  { title: "Bloodless, minimally invasive surgery", desc: "Our NovoLase Gold dental laser enables minimally invasive, suture-free techniques for select soft-tissue procedures, keeping bleeding and post-operative discomfort to a minimum at DR SAWHNEY’S MY DENTIST Kanpur." },
  ...
  { title: "Faster, accelerated healing", desc: "NovoLase Gold laser-assisted photobiomodulation, combined with careful flap design and bone-removal techniques, minimises tissue trauma, reduces swelling and cuts recovery time compared to conventional methods." },
